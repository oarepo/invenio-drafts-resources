...
features_incorporated = '[{"name":"transfers","base":"v3.2.0"}]'

oarepo_major_version = "12"

package_oarepo_version = "oarepo-3.2.0"

configuration = '{"name": "invenio-drafts-resources", "oarepo": 12, "features": [{"name": "transfers", "base": "v3.2.0"}], "depends": [{"on": "invenio-records-resources"}], "package": "invenio-drafts-resources", "invenio_version": "3.2.0", "version": "3.2.0"}'
